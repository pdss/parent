...
@Component("redisCmd")
@Slf4j
public class RedisCommandImpl implements RedisCommand<String, Object> {
    ...
    @Override
    public Set<String> fuzzyQueries(String seach) {
        return redisTemplate.keys(seach);
    }
    ...
    @Override
    public boolean setExpireTime(String key, Long expireTime, TimeUnit unit) {
