...
public class IdWorker {
    ...
    public String nextId64() {
        return StringUtils.rightPad(Long.toBinaryString(this.nextId()), 64, "0");
    }
    public String nextId32() {
        return StringUtils.rightPad(Long.toBinaryString(this.nextId()), 32, "0");
    }
    /**
     * 阻塞到下一个毫秒，直到获得新的时间戳
     *
...
//            System.out.println(StringUtils.rightPad(Long.toBinaryString(id), 64, "0"));
//        }
//    }
}